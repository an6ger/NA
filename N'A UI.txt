...
--local themes = {}
local theme = {
    accent = Color3.fromRGB(165, 98, 142),
    lightcontrast = Color3.fromRGB(07, 07, 07),
    darkcontrast = Color3.fromRGB(8, 8, 8),
...
do
	...
	function utility:Create(instanceType, instanceOffset, instanceProperties, instanceParent)
		...
		if instanceType == "Frame" or instanceType == "frame" then
            ...
            frame.Size = Vector2.new(650,500)
...
do
    ...
    function library:New(info)
		local info = info or {}
        local name = info.name or info.Name or info.title or info.Title or "UI Title"
        local size = info.size or info.Size or Vector2.new(680,500)
        local accent = info.accent or info.Accent or info.color or info.Color or theme.accent
        local callback = info.callback or info.Callback or info.callBack or info.CallBack or function() end
        ...
        do
            ...
            local esppreview_frame = utility:Create("Frame", {Vector2.new(main_frame.Size.X + 5,0), main_frame}, {
                Size = utility:Size(0, 0, 0, 0),
                Position = utility:Position(0, 0, 0, 0, main_frame),
                Color = theme.outline
            ...
            local esppreview_inline = utility:Create("Frame", {Vector2.new(1,1), esppreview_frame}, {
                Size = utility:Size(0, 0, 0, 0, esppreview_frame),
                Position = utility:Position(0, 0, 0, 0, esppreview_frame),
                Color = theme.accent
            }, window.VisualPreview.Drawings)
            --
            ...
            --
            local esppreview_inner = utility:Create("Frame", {Vector2.new(0,0), esppreview_inline}, {
                Size = utility:Size(0, 0, 0, 0, esppreview_inline),
                Position = utility:Position(0, 0, 0, 0, esppreview_inline),
                Color = theme.lightcontrast
            }, window.VisualPreview.Drawings)
            --
            ...
            --
            local esppreview_title = utility:Create("TextLabel", {Vector2.new(0,0), esppreview_inner}, {
                Text = " ",
                Size = theme.textsize,
                Font = theme.font,
                Color = theme.textcolor,
            ...
            do -- Preview Stuff
                ...
                do -- Chams
                    for Index = 1, 2 do
                        local transparency = Index == 0 and 0 or 0
                ...
                do -- Skeleton
                    for Index = 1, 2 do
                        local skeletonsize = Vector2.new(Index == 0 and 0 or 0, Index == 0 and 0 or 0)
                        local skeletonoffset = Vector2.new(Index == 0 and 0 or 0, Index == 0 and 0 or 0)
                        ...
                        local preview_skeleton_head = utility:Create("Frame", {Vector2.new((window.VisualPreview.Components.Chams["Head"][2].Size.X * 0.5) + skeletonoffset.X, (window.VisualPreview.Components.Chams["Head"][2].Size.Y * 0.5) + skeletonoffset.Y), window.VisualPreview.Components.Chams["Head"][2]}, {
                            Size = utility:Size(0, skeletonsize.X, 0, 0, window.VisualPreview.Components.Chams["Head"][0]),
                            Position = utility:Position(0, skeletonoffset.X, 0, skeletonoffset.Y, window.VisualPreview.Components.Chams["Head"][2]),
                            Color = color,
                            Transparency = transparency
                        }, window.VisualPreview.Drawings)
                        --
